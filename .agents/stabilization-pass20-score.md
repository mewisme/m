...
**Final SHA:** `17f47348c9d493e482233151dbcae927ad032c82` (`docs(pass20): align scorecard final SHA with CI headSha`)  
**CI run:** `30463213310` (complete green matrix on exact final SHA)  
...
## CI evidence (run `30463213310` on `17f4734`)
...
| Full CI green on exact final SHA | yes (`17f4734` = run `30463213310` headSha) |
